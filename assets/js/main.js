...
const FALLBACK_PRODUCTS = [
  {
    id: 1, title: "Prostate", cat: "Fertilidad", price: "S/150.00",
  ...
  {
    id: 2, title: "Colágeno Premiun", cat: "Articulaciones", price: "S/ 160.00",
  ...
  {
    id: 3, title: "Omega 3,6,9", cat: "Cardiovascular", price: "$50.00",
    short: "Corazón sano.",
  ...
  {
    id: 4, title: "Creatina", cat: "Ejercicio", price: "$35.00",
    short: "Adiós estrés.",
  ...
  {
    id: 5, title: "Detox Fit", cat: "Digestión", price: "S/160.00",
    short: "Sol en gotas.",
  ...
  {
    id: 6, title: "BioEnergy", cat: "Energia", price: "S/160.00",
    short: "Flora feliz.",
    ...
    media: [{ type: "img", src: "fotos/BioEnergy1.jpeg" }, { type: "img", src: "fotos/BioEnergy2.jpeg" }]
  },
  {
    id: 7, title: "GanoGreen", cat: "Detox", price: "S/160.00",
    short: "Energía.",
  ...
  {
    id: 8, title: "FloraInts", cat: "Digestion", price: "$38.00",
  ...
  {
    id: 9, title: "CalcioZen", cat: "Huesos", price: "S/ 160.00",
  ...
  {
    id: 10, title: "HepZen", cat: "Detox", price: "S/ 160.00",
  ...
  {
    id: 11, title: "GanoGold", cat: "Energía y Defensas", price: "S/ 0.00",
    ...
    media: [{ type: "img", src: "fotos/GanoGold1.jpeg" }, { type: "img", src: "fotos/GanoGold2.jpeg" }, { type: "img", src: "fotos/GanoGold3.jpeg" }]
  },
];
...
async function cargarProductos() {
  ...
  const { data, error } = await supabase
    .from('products')
    .select('id, title, price, short, full, ing, use, product_images ( src )')
    .order('id', { ascending: true });

  if (error) {
    console.error('Supabase error, usando datos locales:', error);
  ...
  return data.map(item => ({
    ...
    media: item.product_images && item.product_images.length > 0
      ...
      : [{ type: 'img', src: 'fotos/default.jpg' }]
  }));
}
